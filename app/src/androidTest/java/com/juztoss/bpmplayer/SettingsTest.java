...
import com.juztoss.bpmplayer.views.activities.SettingsActivity;
...
public class SettingsTest
{
    ...
    public void TestAutoShiftChanged() throws Exception
    {
        ...
        BPMPlayerApp app = ((BPMPlayerApp)activity.getApplicationContext());


        int initialBPMShift = app.getBPMFilterAdditionWindowSize();
        for(int i = 0; i <= (int)BPMPlayerApp.MAX_BPM_SHIFT; i += 2)
        {
            if(i >= (int)BPMPlayerApp.MAX_BPM_SHIFT)
                i = (int)BPMPlayerApp.MAX_BPM_SHIFT;
